...
func TestFrontier_SameX(t *testing.T) {
	...
	testAssert(t, !f.Insert(0.0, -1.0), "Insert2")
	testAssert(t, f.Insert(0.0, 1.0), "Insert3")
...
func TestFrontier_DifferentX(t *testing.T) {
	...
	testAssert(t, f.Insert(2.0, 1.5), "Insert3")
	testAssert(t, !f.Insert(0.3, 0.29), "Insert4")
	testAssert(t, f.Insert(0.3, 0.31), "Insert5")
	testAssert(t, !f.Insert(1.1, 1.04), "Insert6")
	testAssert(t, f.Insert(1.1, 1.06), "Insert7")
}
...
func TestFrontier_RemoveExisting(t *testing.T) {
	...
	testAssert(t, f.Insert(1.1, 2.1), "Insert4")
